...
namespace RawDataCozucu
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                format = "4:2:0";
                file = new FileStream("C:\\Users\\Yagmur\\Desktop\\RawDataCozucu\\foreman_cif_420_352288.yuv", FileMode.Open);
                Dizi = Okuma(file);
            ...
            {
                format = "4:2:2";
                file = new FileStream("E:\\Yaz lab 1\\RawDataCozucu\\foreman_cif_420_352288.yuv", FileMode.Open);
                Dizi = Okuma(file);
                frame = YuvBulma(Dizi, Boyut,format);
                YuvtoBitmap(frame, en, boy);
            }
